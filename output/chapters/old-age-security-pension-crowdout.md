...
| SDT | Moderate for childcare; low for the classic motive | Modest | The classic motive is saturated or wrong-signed, but the grandparental-childcare channel is correctly signed and plausibly contributes at the margin. |
...
The childcare channel changes that conclusion. Later retirement and tighter pension eligibility keep grandparents in paid work. That reduces childcare help for adult children and can lower fertility. This is correctly signed for the SDT. It also comes from the right settings: Germany, the Netherlands, and Australia are rich, below-replacement contexts. The channel is probably not large enough to explain the SDT by itself, but it makes old-age-security and retirement policy a real contributor rather than a non-player.
