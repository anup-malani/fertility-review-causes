...
**Touches:** `literature/search-logs/marriage-market-economics-*`; `output/chapters/marriage-market-economics.md`; `datastore/studies.json`; `literature/AGENT.md`; `literature/wiki/`; `tickets/QUEUE.md`

## Description
Begin the marriage-market and assortative-mating chapter with a reproducible, explicitly
preliminary scoping search. Verify foundational and candidate causal papers, distinguish this
economic matching hypothesis from the demographic sex-ratio hypothesis, and draft a chapter
scaffold without final GRADE or demographic-significance judgments. Formal production screening
