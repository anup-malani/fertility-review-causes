...
|--------|-------|-------|--------------------|---------------|---------|
| [TICK-087](TICK-087-stigma-reduction-contraception-abortion.md) | A.6 Reduction in Stigma Around Contraception and Abortion — selected by the 09-13 frame probe (union frame 680). **Claimed LOCALLY ONLY: the 2026-09-17 push failed on expired credentials, so `ticket.sh`'s `ls-remote` collision check cannot see this claim.** Push `main` and this branch before anyone else claims a number | Shravan | `087-stigma-reduction-contraception-abortion` | 2026-09-17T18:57:58Z | `literature/search-logs/stigma-reduction-contraception-abortion-*`, `extraction/stigma-reduction-contraception-abortion-*`, `output/chapters/stigma-reduction-contraception-abortion.md` |
