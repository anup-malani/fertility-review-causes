...
|--------|-------|-------|--------------------|---------------|---------|
| [TICK-088](TICK-088-diffusion-of-fertility-control.md) | A.3 Diffusion and Social-Learning of Fertility Control — **PARKED 2026-09-17, same day, by its own opening measurement.** `405` found A.3's corrected frame (1,584–2,419) exceeds A.6's (1,225), reversing `404`; A.6 resumed under TICK-087. A.3 still live and unstarted, `405` inheritable. **Claimed LOCALLY ONLY** | Shravan | `088-diffusion-of-fertility-control` | 2026-09-17T19:11:46Z | `literature/search-logs/diffusion-of-fertility-control-*`, `literature/search-logs/a3-term-diagnostics-*`, `extraction/diffusion-of-fertility-control-*`, `output/chapters/diffusion-of-fertility-control.md` |
