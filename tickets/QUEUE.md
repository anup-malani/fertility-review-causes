...
|--------|-------|----------|---------------|
| [TICK-061](TICK-061-document-ticket-creation-rule.md) | Document where ticket creation happens under Mode B, plus the four `ticket.sh` constraints on new ticket files | Shravan | yes |
