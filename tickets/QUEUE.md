...
|--------|-------|-------|--------------------|---------------|---------|
| [TICK-088](TICK-088-diffusion-of-fertility-control.md) | A.3 Diffusion and Social-Learning of Fertility Control — stage 2 opens with a registered-construct completeness test, because A.3 is not yet cleared of the defect that unseated A.6. **Claimed LOCALLY ONLY: the 2026-09-17 push failed on expired credentials, so `ticket.sh`'s collision check cannot see this claim** | Shravan | `088-diffusion-of-fertility-control` | 2026-09-17T19:11:46Z | `literature/search-logs/diffusion-of-fertility-control-*`, `literature/search-logs/a3-term-diagnostics-*`, `extraction/diffusion-of-fertility-control-*`, `output/chapters/diffusion-of-fertility-control.md` |
