...
|--------|-------|-------|--------------------|---------------|---------|
| [TICK-089](TICK-089-population-age-structure-momentum.md) | A.9 Population Age Structure and Demographic Momentum | Shravan | `089-population-age-structure-momentum` | 2026-09-20T18:57:17Z | `literature/search-logs/population-age-structure-momentum-*, extraction/population-age-structure-momentum-*, output/chapters/population-age-structure-momentum.md` |
