...
>
> **Next free number is TICK-077.** Claim a number by pushing its QUEUE.md row before starting work,
...
|--------|-------|-------|--------------------|---------------|---------|
| [TICK-076](TICK-076-heritability-fertility-genetic.md) | A.18 Genetic and Heritable Variation in Fertility — SDT-only arm; scope not yet drafted | Shravan | `076-heritability-fertility-genetic` | 2026-08-31T12:26:41Z | `literature/search-logs/heritability-fertility-genetic-*`, `extraction/heritability-fertility-genetic-*`, `output/chapters/heritability-fertility-genetic.md` |
