...
>
> **Next free number is TICK-071.** Claim a number by pushing its QUEUE.md row before starting work,
...
|--------|-------|-------|--------------------|---------------|---------|
| [TICK-070](TICK-070-twinning-multiple-births.md) | A.12 Twinning Rates and Multiple Births — accounting-identity estimand; DS runs on HMBD + ART registry rates, not on retrieved PDFs | Shravan | `070-twinning-multiple-births` | 2026-08-21T00:36:46Z | `literature/search-logs/twinning-multiple-births-*`, `extraction/twinning-multiple-births-*`, `output/chapters/twinning-multiple-births.md` |
