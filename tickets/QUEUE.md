...
|--------|-------|-------|--------------------|---------------|---------|
| [TICK-080](TICK-080-cross-chapter-statistics-comparability.md) | Cross-chapter statistics — comparability, the demsig routes, and the sign-blind R². **Standing methods ticket; resolutions are retroactive to drafted chapters.** Scoped to 12 items 2026-09-06; no ruling recorded yet, all 14 acceptance criteria open | Shravan | `080-cross-chapter-statistics-comparability` | 2026-09-06T17:25:24Z | `PROTOCOL.md` §4.1–§4.3, `decisions/`, `docs/chapter-template.md`, `source/analysis/`, `output/tables/` |
