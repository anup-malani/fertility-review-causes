...
>
> **Next free number is TICK-066.** Claim a number by pushing its QUEUE.md row before starting work,
...
|--------|-------|-------|--------------------|---------------|---------|
| [TICK-065](TICK-065-fetal-loss-intrauterine-mortality.md) | B.5 Fetal Loss and Intrauterine Mortality | Shravan | `065-fetal-loss-intrauterine-mortality` | 2026-08-12T00:00:30Z
 | `literature/search-logs/fetal-loss-intrauterine-mortality-*`, `extraction/fetal-loss-intrauterine-mortality-*` |
