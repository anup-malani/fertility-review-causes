...
|--------|-------|-------|--------------------|---------------|---------|
| [TICK-063](TICK-063-caldwell-wealth-flows-westernization.md) | D.1.b. Cultural Westernization and Developmental Idealism | Shravan | `063-caldwell-wealth-flows-westernization` | PASTE_TIMESTAMP | `literature/search-logs/caldwell-wealth-flows-westernization-*`, `extraction/caldwell-wealth-flows-westernization-*` |
