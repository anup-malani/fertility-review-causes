...
- corpus in: **17,646**
- kept for screening: **15,586**
- dropped: **1,855** (10.5%)
- routed to the book-review retrieval worklist: **205**
- gold records present in the corpus and run through the filter: **340**
...
| `ART_CLINICAL:cryopreservation` | 11 | 10 | 48% |
...
A review carrying a demographic or religious signal is therefore routed to `BOOK_REVIEW_LEAD` — **205** records. It is not evidence and does not go to the screen; the *reviewed work* is what to chase. The remaining 57 carry no signal and drop.
...
- … and 165 more in `postmaterialism-individualism-secularization-prefilter-v2.json`
