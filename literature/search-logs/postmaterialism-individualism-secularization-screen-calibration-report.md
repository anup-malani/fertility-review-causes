...
- routed away correctly: **7/9**
- **admitted as RELEVANT (failures): 0**

> All decoys routed away. This is the check worth having run before 390 batches.
...
- RELEVANT 14 · UNCERTAIN 12 · NOT_RELEVANT 1 (of 31 empirical anchors)
- pair agreement where the screen committed to one: **21/27**
...
- **Religious Affiliation, Participation and Fertility: A Cautionary Note** → `REVERSE` — Methodological note demonstrating that cross-sectional participation is recorded after births, i.e. it documen
