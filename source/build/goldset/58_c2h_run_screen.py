#!/usr/bin/env python3
"""Run the C.2.h (digital-leisure-substitution) blinded screening batches through a chosen model.

Mirror of the A.3 runner (93): resumable and fail-closed. It never uses a shell, never overwrites a
...
Examples:
  python3 58_c2h_run_screen.py --audit
  python3 58_c2h_run_screen.py --batches 1-3 --command claude -p --model claude-haiku-4-5-20251001
  python3 58_c2h_run_screen.py --command claude -p --model claude-haiku-4-5-20251001
"""
