#!/usr/bin/env python3
"""Run the A.14 (coital-frequency-biological) blinded screening batches through a chosen model.
...
Examples:
  python3 95_a14_run_screen.py --audit
  python3 95_a14_run_screen.py --batches 1-3 --command claude -p --model claude-haiku-4-5-20251001
  python3 95_a14_run_screen.py --command claude -p --model claude-haiku-4-5-20251001
"""
