...
ROWS = [
    ...
    {
        "paperId": "W2752104534", "title": "The Effects of Education on Fertility: Evidence from Taiwan",
        "workstream": "CHILD_ECONOMIC_VALUE_QUANTUM", "fulltext_decision": "INCLUDE_REDUCED_FORM_ONLY",
        "design": "Exact-date regression discontinuity", "setting": "Taiwan, 1980 and 2010 population censuses",
        "reform": "1968 extension of compulsory education from 6 to 9 years", "schooling_first_stage": "Reform substantially increased women's schooling",
        "fertility_outcome": "Fertility status in 1980 and children ever born in 2010",
        "effect_summary": "Exact-date RD estimates show no effect of the reform-induced increase in women's education on fertility",
        "persistence_or_rebound": "Completed fertility measured in 2010", "completed_fertility": "NULL",
        "mechanism": "Prospective woman's own schooling; labor-market and marriage outcomes checked, but child-work value not tested",
        "child_value_mechanism_status": "WRONG_MECHANISM_OWN_SCHOOLING", "synthesis_status": "REDUCED_FORM_CONTEXT_NOT_DIRECT_MECHANISM",
        "source_locator": "Published PDF abstract; Tables 2-4; conclusion",
        "pdf_path": "literature/pdfs/compulsory-education/W2752104534__effects-education-fertility-taiwan.pdf",
    },
    {
        "paperId": "W4405603403", "title": "Child Labour, Fertility, and Gender",
        "workstream": "CHILD_ECONOMIC_VALUE_THEORY", "fulltext_decision": "INCLUDE_MECHANISM_SYNTHESIS",
        "design": "Theory-linked empirical evidence review", "setting": "Historical United States and developing-country evidence",
        "reform": "Compulsory-schooling and child-labor restrictions", "schooling_first_stage": "Review of joint policy variation",
        "fertility_outcome": "Fertility linked to child labor and schooling restrictions",
        "effect_summary": "The chapter reports that restrictions on children's work reduced fertility in historical US evidence, with preferred estimates explaining about 10% of the observed decline",
        "persistence_or_rebound": "Historical fertility decline", "completed_fertility": "REVIEWED_EVIDENCE",
        "mechanism": "Direct linkage between children's economic contribution and parental fertility, with joint endogeneity emphasized",
        "child_value_mechanism_status": "DIRECT_SYNTHESIS_SUPPORT", "synthesis_status": "THEORY_AND_EVIDENCE_NARRATIVE",
        "source_locator": "Second-edition chapter 7, opening evidence review",
        "pdf_path": "literature/pdfs/compulsory-education/W4405603403__child-labour-fertility-gender-evidence.pdf",
    },
    {
        "paperId": "W4405602751", "title": "Internal Policy",
        "workstream": "CHILD_ECONOMIC_VALUE_THEORY", "fulltext_decision": "INCLUDE_POLICY_THEORY",
        "design": "Policy synthesis of child-labor and education models", "setting": "Stylized developing economies",
        "reform": "Partial/total child-labor bans and compulsory education", "schooling_first_stage": "Policy-model equilibria",
        "fertility_outcome": "Excess fertility treated jointly with child labor and insufficient education",
        "effect_summary": "Partial child-labor limits or compulsory education can establish a self-enforcing higher-education equilibrium, whereas total bans may require complementary insurance and education policies",
        "persistence_or_rebound": "Some partial interventions are self-enforcing after equilibrium change", "completed_fertility": "MODEL_IMPLICATION",
        "mechanism": "Child earnings, family income, education returns, and fertility are jointly determined",
        "child_value_mechanism_status": "DIRECT_POLICY_THEORY", "synthesis_status": "THEORY_NARRATIVE",
        "source_locator": "Second-edition chapter 9, especially policy-equilibrium discussion",
        "pdf_path": "literature/pdfs/compulsory-education/W4405602751__internal-policy.pdf",
    },
    {
        "paperId": "W4415043415", "title": "Education, desired fertility, and HIV/AIDS: Evidence from China's compulsory schooling law",
        "workstream": "CHILD_ECONOMIC_VALUE_QUANTUM", "fulltext_decision": "INCLUDE_ADJACENT_PREFERENCE_OUTCOME",
        "design": "Difference-in-differences using age-specific law exposure", "setting": "China",
        "reform": "1986 compulsory-schooling law", "schooling_first_stage": "Each exposure year raises schooling by about 0.37-0.45 years in survey samples",
        "fertility_outcome": "Desired number of children and contraceptive behavior",
        "effect_summary": "One additional year of law exposure reduces women's desired number of children by 0.009, with no detectable effect for men",
        "persistence_or_rebound": "Realized completed fertility not estimated", "completed_fertility": "NOT_OBSERVED",
        "mechanism": "Women's opportunity cost and intrahousehold contraceptive bargaining, not children's work value",
        "child_value_mechanism_status": "WRONG_MECHANISM_OWN_SCHOOLING", "synthesis_status": "ADJACENT_DESIRED_FERTILITY_NOT_REALIZED_QUANTUM",
        "source_locator": "Published PDF abstract; Tables 3 and 5; fertility-preference section",
        "pdf_path": "literature/pdfs/compulsory-education/W4415043415__education-desired-fertility-hiv-aids.pdf",
    },
]
...
ROB = [
    ...
    ["W2752104534", "Exact-date RD", "LOW", "LOW", "LOW", "LOW", "LOW", "LOW", "LOW",
     "Exact birth dates avoid discrete annual-running-variable artifacts; whole-population censuses, density checks, and multiple bandwidths support the null estimate.", "PRELIMINARY_FULLTEXT"],
    ["W4415043415", "Exposure DiD", "SERIOUS", "MODERATE", "MODERATE", "MODERATE", "MODERATE", "MODERATE", "SERIOUS",
