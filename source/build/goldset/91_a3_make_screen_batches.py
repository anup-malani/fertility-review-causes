#!/usr/bin/env python3
"""
91_a3_make_screen_batches.py — A.3 (diffusion and social-learning of fertility control), stage A5 input.

Prepare the full 3,524-candidate Tier-B frame for blinded title/abstract LLM screening. No candidate is
...
Direct mirror of D.3.b step 75 and B.1 step 66. Only SLUG, SEED, and the rubric (A.3's cell taxonomy,
its SIX boundary walls, and the diffusion-identification tag) differ. The six routing decoys must
surface as route-away: La Ferrara-Chong-Duryea + Jensen-Oster -> OFF_CHANNEL_A20; Goldin-Katz ->
OFF_TECHNOLOGY_A2; Fernandez-Fogli -> OFF_VERTICAL_A19; Miller -> OFF_PROGRAM_A5; Lesthaeghe ->
OFF_VALUE_D1 -- the routing check.
...
RUBRIC = """# Blinded title/abstract screening rubric — diffusion & social-learning of fertility control (A.3) — v1
