...
evidence, and preliminary risk-of-bias coding. Current coverage is 21/25 distinct RA-approved
sources: 10/10 compulsory-schooling tempo papers and 12/16 child-economic-value papers. The exact 4-
...
- `output/chapters/compulsory-education-child-economic-value.md` is partial. None of the retrieved
  empirical papers directly identifies the child-work-value mechanism; four approved sources
  remain inaccessible, including two theory chapters and two empirical quantum papers.
...
is RA institutional retrieval of the four queued PDFs. After they are placed in
...
four queued items through the UChicago library; one 2024 Cigno-Rosati ebook covers two queued
