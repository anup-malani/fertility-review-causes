...
## A.3 diffusion-of-fertility-control — through screen + chapter scaffold — 2026-09-18

TICK-088 (branch `088-diffusion-of-fertility-control`) carried A.3 from a parked selection to a
methods-complete chapter scaffold in one session. The `405` park (A.3's frame "too big" at 2,419) was
reopened on the finding that 2,419 priced A.3's own construct `legitimation` as a free `OR` and charged
A.20's channel terms to A.3; priced as its own conjoined frame it is ~719, under threshold. The
